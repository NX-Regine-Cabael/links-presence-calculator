# smartwork-calculator

Applicazione web locale per calcolare automaticamente la percentuale di lavoro agile a partire dagli export Excel di un gestionale di rilevazione presenze.

## Cosa fa

Importa uno o più file `.xlsx` o `.xls` esportati dal gestionale presenze e calcola per ogni anno:
